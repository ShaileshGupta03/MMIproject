...
const postDealerDataNewCoordinates = async (req, res) => {
  ...
  let stations = [];
  console.log("count 2km ", countShop2km);
  console.log("count 5km ", countShop5km);
  console.log("count 15km ", countShop15km);
  ...
  if (countShop2km >= 5) {
    ...
    console.log("2km Stations ", stations);
    ...
    console.log("5km Stations ", stations);
    ...
    console.log("15km Stations ", stations);
    ...
    console.log("20km Stations ", stations);

...
const putInventoryManagement = async (req, res) => {
  try {
    const data = await prisma.inventoryManagementTransfer.update({
      where: {
...
export { getInventoryManagement, getByInventoryManagementId, postInventoryManagement, putInventoryManagement, deleteInventoryManagement };
